      ...
      <div className="rounded-xl border border-cream-border bg-white overflow-hidden">
        <div className="px-5 py-4 border-b border-cream-border bg-cream">
          <p className="text-xs text-gray-500">
            Select an event, add the items you purchased with their quantities, then submit to bulk-fill unit buy in chronological order.
          </p>
        </div>
              ...
              {itemResult.excess > 0 && (
                <div className="px-5 py-2.5 border-b border-cream-border bg-yellow-50 flex items-center gap-2">
                  ...
                  <span className="text-xs text-yellow-700">
                    Excess of <strong>{itemResult.excess}</strong> added to Excess_Purchase sheet
                  </span>
                </div>
              )}
              {itemResult.rows.length === 0 ? (
